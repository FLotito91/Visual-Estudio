...
class Menu:
    def __init__(self):
        ...
        barramenutk = tk.Label(
            ventanaPrincipal, text="Argentina", bg="black", fg="red")
...
6- Salir del programa.''')
    ...
    def agregar_empleado(self):
        while True:
            tipo = input(
                "Ingrese tipo de empleado (Eventual o Permanente) [E/P]: ")
            if tipo in ['e', 'E', 'p', 'P']:
                break
            else:
        ...
        if tipo == 'p' or tipo == 'P':
            ...
            while True:
                una_venta = int(
                    input("Ingrese el monto de una venta, 0 para finalizar: "))
                if una_venta == 0:
                    break
                ventas.append(una_venta)

        self.personal.agregar_empleado(
            nombre, apellido, dni, salario, antiguedad, ventas)
    ...
    def buscar_por_nombre_apellido(self):
        texto_a_buscar = input(
            "Ingrese parte del nombre o apellido a buscar:").capitalize()
